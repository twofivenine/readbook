...
회차의 정체성은 `label`(YYYY-MM)이고, **접속한 달(KST)** 을 기준으로 정합니다.

- **이달의 책** = label ≤ 이번 달인 확정 회차 중 가장 최근. 10월의 책은 10월이 되어야 홈에 올라옵니다
- **미리 정해진 책** = label > 이번 달인 확정 회차. 이달의 책 카드 하단에 표시됩니다
- **서재** = label < 이번 달인 확정 회차. 서재에서 "지난 책 추가"로 예전 책을 직접 올릴 수 있습니다(같은 달에 책이 있거나 투표가 진행 중이면 거부)
- **책 투표** = 진행 중인 투표가 있으면 그것, 없으면 마지막 확정 회차의 다음 달에 새로 열림. 마감·확정해도 그 달이 올 때까지는 "미리 정해진 책"에 머뭅니다
- **다음 모임·참석·장소 투표** = 이달의 책 회차. 그 모임일이 지나고 미리 정해진 회차가 있으면 그쪽으로 넘어갑니다
- 책의 "읽는 달"은 이달의 책 카드의 "책 정보 수정"에서 바꿀 수 있습니다
