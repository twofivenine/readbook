-- 회차를 월 기준으로 바꾸는 변경 (v1.1.2). Supabase SQL Editor 에 붙여 넣고 Run.
...
VALUES (gen_random_uuid()::text, '775d829d20d8bf5d91df53ce728e429efc9da6188cd9fdda029f7d6385dd861c', now(), '20260917060000_month_rounds', 1)
